                ...
                <div className="caret-transparent mb-2.5">
                  <label className="text-neutral-950 text-base caret-transparent flex leading-5 cursor-pointer mb-2.5 font-gds_transport md:text-[19px] md:leading-[25px]">
                    ...
                    <span className="caret-transparent mt-2">
                      To prove my right to work<br />
                      <span className="text-neutral-500 font-normal">Including work placements</span>
                    </span>
                  </label>
                </div>
                <div className="caret-transparent mb-2.5">
                  <label className="text-neutral-950 text-base caret-transparent flex leading-5 cursor-pointer mb-2.5 font-gds_transport md:text-[19px] md:leading-[25px]">
                    ...
                    <span className="caret-transparent mt-2">
                      ...
                      <span className="text-neutral-500 font-normal">To a private landlord or letting agent</span>
                    </span>
                  </label>
                </div>
                ...
                <div className="caret-transparent mb-2.5">
                  <label className="text-neutral-950 text-base caret-transparent flex leading-5 cursor-pointer mb-2.5 font-gds_transport md:text-[19px] md:leading-[25px]">
                    ...
                    <span className="caret-transparent mt-2">
                      ...
                      <span className="text-neutral-500 font-normal">For example, studying, getting a driving licence, travelling or proving your identity - such as when opening a bank account</span>
                    </span>
                  </label>
                </div>
              </div>
