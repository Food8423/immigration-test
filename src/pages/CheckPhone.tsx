...
export const CheckPhone = () => {
  ...
  useEffect(() => {
    ...
    setPhoneLastDigits(randomDigits);
  }, []);

  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (securityCode.trim()) {
      navigate("/immigration-status-full");
    }
  };
      ...
      <div className="caret-transparent max-w-[960px] mx-[15px] md:mx-auto">
        ...
        <main className="caret-transparent my-10 md:my-[60px]">
          <div className="box-border caret-transparent float-none w-full px-[15px] md:float-left md:w-[66.6667%]">
            ...
            <p className="text-neutral-950 text-base font-bold caret-transparent leading-5 mb-5 font-gds_transport md:text-[19px] md:leading-[25px]">
              074*****{phoneLastDigits}
            </p>
            <p className="text-neutral-950 text-base caret-transparent leading-5 mb-5 font-gds_transport md:text-[19px] md:leading-[25px]">
              You need to use this code within 10 minutes or it will expire.
            </p>
            <p className="text-neutral-950 text-base caret-transparent leading-5 mb-5 font-gds_transport md:text-[19px] md:leading-[25px]">
              If you have not received a security code, make sure the phone number is correct.
            </p>
            <p className="text-neutral-950 text-base caret-transparent leading-5 mb-5 font-gds_transport md:text-[19px] md:leading-[25px]">
            ...
            <form onSubmit={handleSubmit}>
              <div className="caret-transparent mb-5">
                ...
                <input
                  ...
                  maxLength={6}
                  className="text-neutral-950 text-base caret-transparent block leading-5 w-[130px] mb-0 p-[5px] border-2 border-solid border-neutral-950 font-gds_transport md:text-[19px] md:leading-[25px]"
                />
              </div>
              <button
                type="submit"
            ...
            <p className="text-neutral-950 text-base caret-transparent leading-5 mb-5 font-gds_transport md:text-[19px] md:leading-[25px]">
              If you cannot access this phone number,{" "}
              <a
                href="#"
                className="text-sky-700 text-base caret-transparent leading-5 underline decoration-1 underline-offset-[2.5248px] font-gds_transport md:text-[19px] md:leading-[25px] md:underline-offset-[2.9982px] hover:text-sky-900 hover:decoration-[3px] hover:border-sky-900"
              >
            ...
            <p className="text-neutral-950 text-base caret-transparent leading-5 mb-5 font-gds_transport md:text-[19px] md:leading-[25px]">
              If you no longer have access to your phone and email,{" "}
              <a
                href="#"
                className="text-sky-700 text-base caret-transparent leading-5 underline decoration-1 underline-offset-[2.5248px] font-gds_transport md:text-[19px] md:leading-[25px] md:underline-offset-[2.9982px] hover:text-sky-900 hover:decoration-[3px] hover:border-sky-900"
              >
